...
class RustlibWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_rust_crop_imagePtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_rust_crop_image');
  late final _wire_rust_crop_image = _wire_rust_crop_imagePtr.asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();
